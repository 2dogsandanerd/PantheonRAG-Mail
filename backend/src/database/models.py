...
class ConversationFeedback(Base):
    """Feedback on generated responses linked to conversations."""
    ...
    # Intentionally no back_populates: User/Conversation currently expose no matching relationship fields.
