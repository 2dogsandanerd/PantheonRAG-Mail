                    ...
                    if not collections_to_query:
                        ...
                        if rag_response["context"] or facts_context:
                            ...
                            if (
                                ...
                                # External RAG connector format - need to transform
                                # The external connector returns the raw response from the API
                        ...
                        logger.info(
                            f"RAG query: {rag_result_count} results + Graph-Lite Facts. "
                            f"Status: {rag_status}"
                        )
