...
class CollectionManager:
    ...
    async def create_collection(
        ...
        try:
            ...
            default_provider = config.embedding_provider
            
            embedding_provider = embedding_config.get("provider", default_provider) if embedding_config else default_provider
            
            # Default model handling (mock model for mock provider)
            default_model = "mock-model" if embedding_provider == "mock" else "nomic-embed-text:latest"
